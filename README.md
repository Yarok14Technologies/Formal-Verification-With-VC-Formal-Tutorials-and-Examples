...
This repository is a **structured learning and reference resource** for **Formal Verification using Synopsys VC Formal**.
It covers **core concepts, real applications, setup guides, reports, and project artifacts**, suitable for **students, researchers, and industry engineers**.
